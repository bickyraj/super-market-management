...
const PageHeader: React.FC = () => {
    ...
    return (
        <>
            {pageTitle && ((
                <div
                    className={`transition-all duration-300 ease-in-out bg-white ${isCollapsed ? 'lg:ml-28 md:ml-44' : 'lg:ml-64 md:ml-44'} lg:flex px-7 py-3 lg:items-center lg:justify-between mb-3 mt-[70px]`}>
